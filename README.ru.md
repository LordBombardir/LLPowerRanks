...
* Менеджер конфигурации языков (используется [i18n](https://github.com/LiteLDev/LeviLamina/tree/main/src/ll/api/i18n/)). Папка с языками - *languages*
...
* Менеджер управления базой данных типа *LevelDB*. В ней хранятся данные игроков, а именно - UUID игрока, предоставленный [PlayerDB](https://github.com/LordBombardir/LLPlayerDB-Release), и его ранг
