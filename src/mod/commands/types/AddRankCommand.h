...
public:
    struct Parameter {
        ...
        std::string                                      chat;
        std::string                                      scoreTag;
        ll::command::SoftEnum<CommandManager::RankNames> inheritanceRank = "null";
    };

    static std::string getName() { return "addrank"; };
    static std::string getDescription() { return LanguageManager::getTranslate("commandAddRankDescription"); };
